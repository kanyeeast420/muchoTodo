...
export const Todo: React.FC<TodoProps> = ({ name, _id }) => {
  return (
    <div className=" transition-all ease-in duration-500 todo max-w-full h-fit overflow-hidden text-clip p-4 text-white lg:px-24 lg:py-10  h-full w-full text-base md:text-2xl lg:text-3xl border-2 border-slate-700 rounded flex flex-col md:items-center md:justify-center text-center">
      <span>{name}</span>
