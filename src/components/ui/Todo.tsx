...
export const Todo: React.FC<TodoProps> = ({ name, _id }) => {
  return (
    <div className=" transition-all ease-in duration-500 todo text-white lg:px-24 lg:py-10 p-2 h-full w-full text-base md:text-2xl lg:text-3xl border-2 border-slate-700 rounded flex flex-col items-center justify-center text-center">
      <span>{name}</span>
